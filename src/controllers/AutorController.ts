      ...
      try {
        switch (opcao) {
          case '1':
            ...
            const nacionalidade = readline.question('Nacionalidade (opcional): ');
            const novoAutor = await this.autorService.cadastrarAutor(nome, nacionalidade);
          ...
          case '2':
            ...
            autores.forEach(a => console.log(`[ID: ${a.id}] ${a.nome} (${a.nacionalidade || 'Não informada'})`));
            break;
          case '3':
